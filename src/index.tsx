  ...
  return c.html(`
    ...
    <body class="bg-gradient-to-br from-pink-50 to-purple-50 min-h-screen">
        ...
        <script>
            ...
            var genreHooks = {
                food: [
                    "おいしいものは人を幸せにする、それは間違いない！",
                    "頑張った自分へのご褒美、今日くらい贅沢してもいいよね！",
                    "一口食べたら止まらない、そんな幸せ体験しませんか？",
                    "大切な人へ贈りたい、もらって嬉しいグルメがここに！",
                    "お取り寄せで発見！これはリピート確定の美味しさ！",
                    "自分用にもギフトにも◎ 間違いないこの味！",
                    "食べた瞬間「これだ！」ってなるやつ、見つけました！",
                    "毎日がんばるあなたに、とっておきのご褒美スイーツ！",
                    "SNSで話題のあの味、もう試した？"
                ],
                fashion: [
                    "おしゃれは自分を好きになる第一歩！",
                    "着るだけで気分が上がる、そんなアイテム見つけた！",
                    "いつものコーデが一気に垢抜ける魔法のアイテム！",
                    "周りから「それどこの？」って聞かれるやつ！",
                    "プチプラなのに高見え！これは買わなきゃ損！",
                    "今季トレンドを押さえたい人、これ一択です！"
                ],
                beauty: [
                    "キレイは毎日のケアから！始めるなら今！",
                    "使った翌朝の肌に感動、そんな体験をあなたにも！",
                    "自分へのご褒美コスメ、たまには贅沢してもいいよね！",
                    "リピーター続出！一度使ったら手放せないケアアイテム！",
                    "忙しい毎日でもキレイでいたい、を叶えるアイテム！"
                ],
                lifestyle: [
                    "暮らしがちょっと豊かになる、そんな逸品を発見！",
                    "毎日使うものだからこそ、いいものを選びたいよね！",
                    "生活の質が上がる！一度使ったら戻れないアイテム！",
                    "これがあるだけで毎日がもっと快適になる！",
                    "シンプルだけど実力派、使えばわかるこの便利さ！"
                ],
                kids: [
                    "子どもの笑顔が見たいなら、これで決まり！",
                    "ママパパの強い味方！育児がラクになるアイテム！",
                    "お子さんへのプレゼントに迷ったらこれ！",
                    "子育て中の「あったらいいな」を叶えるアイテム！"
                ],
                cleaning: [
                    "面倒な掃除が楽しくなる！そんな魔法のアイテム！",
                    "サボりがちな掃除も、これがあればやる気が出る！",
                    "ラクしてキレイが手に入る、ズボラさんの味方！",
                    "汚れがスルッと落ちる快感、一度味わったらやみつき！"
                ],
                outdoor: [
                    "外に出かけたくなる！アウトドアの必須アイテム！",
                    "週末の冒険が10倍楽しくなるギアを発見！",
                    "キャンプ好きなら絶対チェックしてほしい逸品！",
                    "自然の中で過ごす最高の時間に、これがあれば完璧！"
                ],
                electronics: [
                    "テクノロジーで暮らしをアップデートしよう！",
                    "こんなの欲しかった！かゆいところに手が届くガジェット！",
                    "時短＆効率アップ！デジタルの力を味方につけよう！",
                    "一度使ったらもう手放せない、便利すぎるアイテム！"
                ],
                gift: [
                    "大切な人へ贈りたい、センス抜群のギフト！",
                    "もらって嬉しい、贈って楽しい、そんなプレゼント！",
                    "「ありがとう」を形にするなら、これがおすすめ！",
                    "ギフト選びに迷ったら、これで間違いなし！"
                ],
                general: [
                    "これ見つけた時、即ブックマークしました！",
                    "知る人ぞ知る隠れた名品、こっそり教えます！",
                    "口コミで広がってる実力派、チェックしないと損！",
                    "みんなが「もっと早く買えばよかった」って言うやつ！",
                    "楽天で見つけた、コスパ最強のアイテムがこちら！"
                ]
            };

            // 商品名からジャンルを判定する関数
            function detectGenre(productName) {
                var name = productName.toLowerCase();
                
                // 食品・スイーツ
                if (/チョコ|ケーキ|クッキー|スイーツ|お菓子|グルメ|食品|米|肉|魚|野菜|果物|フルーツ|ナッツ|ドリンク|コーヒー|紅茶|茶|ジュース|ビール|ワイン|酒|ラーメン|うどん|そば|パスタ|パン|ジャム|はちみつ|調味料|醤油|味噌|お取り寄せ|アイス|プリン|ゼリー|和菓子|洋菓子|おつまみ|せんべい|まんじゅう|大福|タルト|ワッフル|バウムクーヘン|カステラ|ドーナツ|マカロン/.test(name)) return 'food';
                
                // ファッション
                if (/パンツ|スカート|ワンピース|トップス|コート|ジャケット|シャツ|ブラウス|ニット|セーター|靴|スニーカー|ブーツ|サンダル|バッグ|帽子|アクセサリー|ネックレス|ピアス|イヤリング|指輪|リング|ストール|マフラー|手袋|財布|ベルト|ソックス|靴下|下着|パジャマ|ルームウェア/.test(name)) return 'fashion';
                
                // 美容・コスメ
                if (/化粧|コスメ|美容|スキンケア|クリーム|ローション|美容液|パック|マスク|シャンプー|トリートメント|ヘアケア|ボディ|日焼け止め|UV|ファンデ|リップ|アイシャドウ|香水|ネイル|脱毛|美顔器/.test(name)) return 'beauty';
                
                // 子ども・ベビー
                if (/キッズ|ベビー|赤ちゃん|子供|子ども|おもちゃ|知育|ランドセル|出産|マタニティ|授乳|離乳食|おむつ/.test(name)) return 'kids';
                
                // 掃除
                if (/掃除|クリーナー|モップ|ほうき|洗剤|スポンジ|ブラシ|ぞうきん|雑巾|フローリング/.test(name)) return 'cleaning';
                
                // アウトドア
                if (/キャンプ|アウトドア|テント|バーベキュー|BBQ|ランタン|寝袋|登山|ハイキング|釣り|フィッシング/.test(name)) return 'outdoor';
                
                // 家電・ガジェット
                if (/家電|電動|充電|USB|LED|ドライバー|イヤホン|スピーカー|モバイルバッテリー|ドライヤー|加湿器|除湿|扇風機|ヒーター|レコーダー|カメラ|時計|スマート/.test(name)) return 'electronics';
                
                // ギフト
                if (/ギフト|プレゼント|贈り物|お祝い|内祝|お中元|お歳暮|母の日|父の日|誕生日|記念日|出産祝|結婚祝/.test(name)) return 'gift';
                
                // 生活用品
                if (/タオル|食器|カップ|マグ|キッチン|収納|インテリア|照明|カーテン|ラグ|枕|布団|マットレス|クッション|フライパン|鍋/.test(name)) return 'lifestyle';
            ...
            function generateDescription(product) {
                var genre = detectGenre(product.name);
                var hooks = genreHooks[genre] || genreHooks['general'];
